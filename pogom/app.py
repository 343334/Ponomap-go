...
from . import config
from .models import Pokemon, Gym, Pokestop, ScannedLocation, MainWorker, WorkerStatus, Spawnpoints, HashKeys
...
class Pogom(Flask):
    ...
    def raw_data(self):
        ...
        exclude = request.args.get('eids')
        invert = request.args.get('invert')
        user = request.args.get('user')
        log.debug('Invert exclude: {}, list: {}, user: {}'.format(invert, exclude, user))
