...
var pokemonSprites = {
  normal: {
    ...
    spriteWidth: 1488,
    spriteHeight: 1008,
    filename: 'static/icon-small-sprite.png',
    name: 'Normal'
  },
  highres: {
    columns: 31,
...
function setupPokemonMarker (item, map, isBounceDisabled) {
  ...
  var iconSize = 2 + (map.getZoom() - 3) * (map.getZoom() - 3) * 0.3 + Store.get('iconSizeModifier') + 5
  var pokemonIndex = item['pokemon_id'] - 1
  var sprite = pokemonSprites[Store.get('pokemonIcons')] || pokemonSprites['normal']
